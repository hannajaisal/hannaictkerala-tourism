...
function svalidate()
{
    ...
    else if(psr.test(spswd.value)!="1")
    {
        ...
        window.alert("Password should be of minimum 8 characters, at least one uppercase, and one lower case,  special character, must contain at least one number");
        window.alert("try again");
        return false;
    }
    else  if(spswd.value!=spswd2.value)
    {
        window.alert("Passwords Doesnt Match, Please retype");
        return false;
    }
    else
    {
